...
public class Address extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (getAid() != null ? !getAid().equals(address1.getAid()) : address1.getAid() != null) {
            return false;
        }
        if (getUid() != null ? !getUid().equals(address1.getUid()) : address1.getUid() != null) {
            return false;
        }
        if (getName() != null ? !getName().equals(address1.getName()) : address1.getName() != null) {
            return false;
        }
        ...
        if (getZip() != null ? !getZip().equals(address1.getZip()) : address1.getZip() != null) {
            return false;
        }
        if (getAddress() != null ? !getAddress().equals(address1.getAddress()) : address1.getAddress() != null) {
            return false;
        }
        if (getPhone() != null ? !getPhone().equals(address1.getPhone()) : address1.getPhone() != null) {
            return false;
        }
        if (getTel() != null ? !getTel().equals(address1.getTel()) : address1.getTel() != null) {
            return false;
        }
        if (getTag() != null ? !getTag().equals(address1.getTag()) : address1.getTag() != null) {
            return false;
        }
